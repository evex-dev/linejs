class TMoreCompactProtocol extends TCompactProtocol {
    ...
    g(t, fid = null) {
        ...
        if (t === 2) {
            ...
            a = [];  // base
            let dec = new Thrift.TCompactProtocol(this.cl);  // init
            let [ftype, count, offset] = dec.readCollectionBegin(this.data.slice(this.__last_pos));  // read
        ...
        dummyProtocol.data = new DummyProtocolData(fid, t, dummyProtocolData, subType);  // good
