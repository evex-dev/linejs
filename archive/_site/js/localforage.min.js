	...
	return function a(b, c, d) {
	...
	}(
		{
			...
			4: [function (a, b, c) {
				...
				function f() {
					try {
						...
						var a = "undefined" != typeof openDatabase &&
							...
							b = "function" == typeof fetch &&
								-1 !== fetch.toString().indexOf("[native code");
						return (!a || b) && "undefined" != typeof indexedDB &&
							...
							try {
								...
								console.warn(
									'The database "' + a.name +
										...
										" to version " + b.newVersion + ', but the storage "' +
										a.storeName + '" already exists.',
								);
							}
						}),
				...
				function R(a, b, c, d) {
					a.executeSql(
						"CREATE TABLE IF NOT EXISTS " + b.storeName +
							...
							i.serializer.serialize(b, function (b, j) {
								j ? g(j) : i.db.transaction(function (c) {
									T(
										c,
										i,
										"INSERT OR REPLACE INTO " + i.storeName +
											" (key, value) VALUES (?, ?)",
										[a, b],
										function () {
											f(h);
				...
				function da() {
					try {
						return "undefined" != typeof localStorage &&
							"setItem" in localStorage && !!localStorage.setItem;
					} catch (a) {
						return !1;
					}
				}
							...
							g.serializer.serialize(b, function (b, d) {
								if (d) f(d);
										...
										"QuotaExceededError" !== a.name &&
											"NS_ERROR_DOM_QUOTA_REACHED" !== a.name || f(a), f(a);
									}}
							});
						});
					});
						...
						"function" == typeof Symbol && "symbol" == typeof Symbol.iterator
							...
							: function (a) {
								return a && "function" == typeof Symbol &&
										a.constructor === Symbol && a !== Symbol.prototype
									? "symbol"
									: typeof a;
							},
					ua = e();
				...
				var va = Promise,
					...
					Ya = function (a, b) {
						return a === b ||
							"number" == typeof a && "number" == typeof b && isNaN(a) &&
								isNaN(b);
					},
					Za = function (a, b) {
								...
								var d = new va(function (b, c) {
									try {
										...
										for (
											...
											var j = f[g];
											if (
												(!Za(db, j) || a[j]) && "function" != typeof a[j]
											) return void c(e);
										}
										(function () {
											for (
