			...
			div(
				...
				div(
						...
						ul(
							...
							li(
								...
								div(
									{
										"class":
											"gnb-module__badge__nU45a badge-module__badge__Eh36I ",
									},
									"25",
								),
							),
										...
										svg(
											...
											g(
												...
												path(
													{
														"d":
															"m19.088 15.33-9.068 5.149a3.907 3.907 0 0 1-5.86-3.329v-1.62a3.1 3.1 0 0 1 1.579-2.69l4.351-2.47a.728.728 0 0 0 .367-.63.736.736 0 0 0-.149-.44.756.756 0 0 0-.963-.18L5.7 11.19a1.023 1.023 0 0 1-1.54-.87V6.851a3.908 3.908 0 0 1 5.86-3.33l9.068 5.149a3.816 3.816 0 0 1 0 6.66z",
													},
												),
											),
										),
										...
										svg(
											...
											g(
												...
												path(
													{
														"d":
															"M19.7 19.982V9.018c0-2.606-2.163-4.718-4.832-4.718H9.132C6.463 4.3 4.3 6.412 4.3 9.018v5.6c0 2.605 2.163 4.717 4.832 4.717h5.908",
														"stroke": "#707991",
														"stroke-width": "3",
														"style": "color: #202a43;",
													},
										...
										svg(
											...
											g(
												...
												path(
													{
														"d":
															"M12 10.5c.829 0 1.5.671 1.5 1.5s-.671 1.5-1.5 1.5-1.5-.671-1.5-1.5.671-1.5 1.5-1.5Zm5.9722 0c.828 0 1.5.671 1.5 1.5s-.672 1.5-1.5 1.5c-.829 0-1.5-.671-1.5-1.5s.671-1.5 1.5-1.5Zm-11.9444-.0003c.208 0 .405.042.584.118.18.076.341.186.477.322.272.271.439.646.439 1.06 0 .414-.167.789-.439 1.061-.136.136-.297.245-.477.322-.179.075-.376.117-.584.117-.828 0-1.5-.671-1.5-1.5 0-.828.672-1.5 1.5-1.5Z",
													},
												),
											),
										),
					...
					div(
						{
							"class":
								"chatlist-module__tab__xaUJd folderTab-module__tab__YXsQR",
						},
						div(
							{
																...
																path(
																	{
																		"fill": "#C8C8C8",
																		"d":
																			"M12 5c3.866 0 7 3.134 7 7s-3.134 7-7 7-7-3.134-7-7 3.134-7 7-7zm2.413 3.5L12 10.912 9.587 8.5 8.5 9.587 10.912 12 8.5 14.413 9.587 15.5 12 13.087l2.413 2.413 1.087-1.087L13.087 12 15.5 9.587 14.413 8.5z",
																		"transform":
																			"translate(-1216.000000, -227.000000) translate(928.000000, 162.000000) translate(14.000000, 58.000000) translate(274.000000, 7.000000)",
																	},
																),
						...
						div(
							...
							button(
								...
								i(
									...
									img({
										src:
											"https://static.line-scdn.net/Openchat-Real/edge/img/apng/icon-nav-create.png",
										alt: "",
									}),
								),
							),
							div(
								...
								ul(
									...
									li(
										{
											"class":
												"createChatButton-module__action_list_item__I1EVN",
										},
										button(
											{
					...
					div(
						{
							"class":
								"notificationStateToast-module__notification_toast__b7WP7 ",
							"data-visible": "false",
						},
						i(
							{
