							...
							svg(
								...
								g(
									...
									path(
										{
											"d":
												"M12 10.5c-.829 0-1.5.671-1.5 1.5s.671 1.5 1.5 1.5 1.5-.671 1.5-1.5-.671-1.5-1.5-1.5Zm0-2.9722c.829 0 1.5-.671 1.5-1.5 0-.828-.671-1.5-1.5-1.5s-1.5.672-1.5 1.5c0 .829.671 1.5 1.5 1.5Zm0 8.9444c-.829 0-1.5.671-1.5 1.5 0 .311.094.599.256.838.054.08.116.155.183.223.272.271.647.439 1.061.439.414 0 .789-.168 1.061-.439.067-.068.129-.143.183-.223.162-.239.256-.527.256-.838 0-.829-.671-1.5-1.5-1.5Z",
										},
									),
								),
							),
		...
		div(
			{
				...
				"style":
					"--full-viewer-text-bottom: 24px; --full-viewer-inner-height: 54px;",
			},
			div(
				{
						...
						svg(
							...
							g(
								...
								path(
									{
										"d":
											"M8.6233 13.1151a.65.65 0 0 1 .8882.237c.4976.8597 1.4261 1.4359 2.4887 1.4359 1.0626 0 1.9911-.5762 2.4887-1.4359a.65.65 0 0 1 1.1252.6512c-.7206 1.2449-2.0689 2.0847-3.6139 2.0847s-2.8932-.8398-3.6138-2.0847a.65.65 0 0 1 .237-.8882ZM14.7773 9.2964c-.5522 0-1 .4477-1 1s.4478 1 1 1c.5523 0 1-.4477 1-1s-.4477-1-1-1Zm-5.5546 0c-.5523 0-1 .4477-1 1s.4477 1 1 1c.5522 0 1-.4477 1-1s-.4478-1-1-1Z",
									},
								),
								path(
									{
										"d":
											"M12 4.05c-4.3907 0-7.95 3.5593-7.95 7.95 0 4.3907 3.5593 7.95 7.95 7.95 4.3907 0 7.95-3.5593 7.95-7.95 0-4.3907-3.5593-7.95-7.95-7.95ZM2.75 12c0-5.1086 4.1414-9.25 9.25-9.25s9.25 4.1414 9.25 9.25-4.1414 9.25-9.25 9.25S2.75 17.1086 2.75 12Z",
									},
								),
							),
						),
						...
						svg(
							...
							g(
								...
								path(
									{
										"d":
											"M4.4263 19.0055v-7.967h1.3V18.85h12.5461v-7.8115h1.3v7.967c0 .6321-.5124 1.1445-1.1445 1.1445H5.5708c-.6321 0-1.1445-.5124-1.1445-1.1445Zm7.5731-15.4009 4.1008 3.885-.894.9438-3.2068-3.038-3.2069 3.038-.894-.9438 4.1009-3.885Z",
									},
								),
								path(
									{
										...
										svg(
											...
											g(
												...
												path(
													{
														"d":
															"M15.5519 8.5134c-.5769 0-1.0446.4678-1.0446 1.0447 0 .577.4677 1.0447 1.0446 1.0447s1.0446-.4677 1.0446-1.0447c0-.5769-.4677-1.0447-1.0446-1.0447ZM8.6929 10.2734l8.5795 8.5796a.6498.6498 0 0 1 0 .9192.6498.6498 0 0 1-.9192 0l-7.6603-7.6604-4.4334 4.4335a.65.65 0 1 1-.9192-.9192l5.3526-5.3527Z",
													},
												),
												path(
													{
														"d":
															"M4.4499 5.3375v13.3251h15.1V5.3375h-15.1Zm-1.3-.15c0-.6353.515-1.15 1.15-1.15h15.4c.635 0 1.15.5147 1.15 1.15v13.6251c0 .6353-.515 1.15-1.15 1.15h-15.4c-.635 0-1.15-.5149-1.15-1.15V5.1875Z",
													},
												),
											),
										),
