	...
	if (args) {
		if (args.currencyExchangeRates !== undefined && args.currencyExchangeRates !== null) {
			this.currencyExchangeRates = Thrift.copyList(args.currencyExchangeRates, [
				ttypes.PaidCallCurrencyExchangeRate,
			]);
		}
...
ttypes.Settings = function (args) {
	...
	if (args) {
		...
		if (
			args.privacyReceiveMessagesFromNotFriend !== undefined && args.privacyReceiveMessagesFromNotFriend !== null
		) {
...
ttypes.SquareEventPayload = function (args) {
	...
	if (args) {
		...
		if (
			args.notifiedUpdateSquareChatProfileName !== undefined && args.notifiedUpdateSquareChatProfileName !== null
		) {
		...
		if (
			...
			this.notifiedUpdateSquareChatProfileImage = new ttypes.SquareEventNotifiedUpdateSquareChatProfileImage(
				args.notifiedUpdateSquareChatProfileImage,
			);
		}
...
ttypes.SquareEventPayload.prototype.read = function (input) {
	...
	while (true) {
		...
		switch (fid) {
			...
			case 31:
				if (ftype == Thrift.Type.STRUCT) {
					this.notifiedUpdateSquareChatProfileName = new ttypes
			...
			case 32:
				if (ftype == Thrift.Type.STRUCT) {
					this.notifiedUpdateSquareChatProfileImage = new ttypes
			...
			case 18:
				if (ftype == Thrift.Type.STRUCT) {
					this.notifiedUpdateSquareMemberRelation = new ttypes
