...
import ThriftRenameParser from "../site/rename_thrift.js";
...
const line_thrift = new ThriftRenameParser(
    await Deno.readTextFile("./line.thrift"),
);
...
export default class lineClient extends LoginAPI {
    constructor(authToken, device) {
        ...
        this.device = device;
        if (!authToken) {
            console.log("No authToken: requestEmailLogin(email,pw) to Login")
        }
    }
